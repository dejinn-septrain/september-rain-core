...
import net.dejinn.septemberRainCore.JavaShit.YawCardinal;
...
public class BlockPlace implements Listener {
    ...
    public void placeBlock(BlockPlaceEvent e){
        ...
        Location roundedLoc = YawCardinal.roundLocation(location);
        ...
        if (placedItemMeta.getPersistentDataContainer().has(Main.getItemInstance().getTag())){
            ...
            Main.getBlockInstance().PlaceCustomBlock(customBlockId,location,roundedLoc);
